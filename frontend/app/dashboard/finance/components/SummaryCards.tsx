...
export function SummaryCards({ data, isLoading }: { data: any, isLoading: boolean }) {
    ...
    const Skeleton = () => <div className="h-8 w-24 bg-slate-200 dark:bg-slate-700 animate-pulse rounded" />;
    ...
    return (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-8">
            ...
            <Card>
                ...
                <CardContent>
                    {isLoading ? <Skeleton /> : <div className="text-2xl font-bold">{formatDate(safeData.last_document_date)}</div>}
            ...
            <Card>
                ...
                <CardContent>
                    {isLoading ? <Skeleton /> : <div className="text-xl font-bold truncate" title={safeData.last_entity_name}>{safeData.last_entity_name || "-"}</div>}
            ...
            <Card>
                ...
                <CardContent>
                    {isLoading ? <Skeleton /> : <div className="text-2xl font-bold">{formatCurrency(safeData.cash_flow_last_month)}</div>}
            ...
            <Card>
                ...
                <CardContent>
                    {isLoading ? <Skeleton /> : <div className="text-2xl font-bold">{formatCurrency(safeData.total_payments_last_month)}</div>}
            ...
            <Card>
                ...
                <CardContent>
                    {isLoading ? <Skeleton /> : <div className="text-2xl font-bold">{formatDate(safeData.last_reconciliation_date)}</div>}
            ...
            <Card>
                ...
                <CardContent>
                    {isLoading ? <Skeleton /> : <div className="text-2xl font-bold">{formatDate(safeData.last_tax_return_date)}</div>}
            ...
            <Card>
                ...
                <CardContent>
                    {isLoading ? <Skeleton /> : <div className="text-2xl font-bold">{formatCurrency(safeData.total_payroll_last_run)}</div>}
            ...
            <Card>
                ...
                <CardContent>
                    {isLoading ? <Skeleton /> : <div className="text-2xl font-bold">{safeData.pending_tasks_count || 0}</div>}
                    <p className="text-xs text-muted-foreground">مهام معلقة تتطلب الانتباه</p>
                </CardContent>
            </Card>
        </div>
    );
